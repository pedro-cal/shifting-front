...
export default function Header() {
  return (
    <>
      <header className="absolute top-0 left-0 z-20 flex w-full h-[10vh] flex-col bg-none p-3 px-8 sm:flex-row lg:h-[10vh]">
        ...
        <div className="z-30 w-1/2">
          <button className="flex h-full flex-row place-content-center items-center">
            ...
            <p className="pl-2 text-stone-50 font-black lg:text-3xl 2xl:pl-4 2xl:text-3xl">Shifting</p>
          </button>
        </div>
